...
Read more: [What We Discovered](docs/EN/WHAT_WE_DISCOVERED.md) | [Emergence Essay](assets/emergence-mechanisms.md)

---

## 📚 Repository Structure

Single English codebase with bilingual documentation:

### **[→ Documentation](docs/)**
- **[English docs](docs/EN/)** - Complete documentation in English
- **[Nederlandse docs](docs/NL/)** - Volledige documentatie in het Nederlands

### **[→ Code & Research](src/)**
All code in English for international collaboration.
...
Full story: [Evolution from Scripts to Reasoning](docs/EN/EVOLUTION_FROM_SCRIPTS_TO_REASONING.md)
