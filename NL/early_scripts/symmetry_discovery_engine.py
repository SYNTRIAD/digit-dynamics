...
Een AI-gedreven systeem voor autonome ontdekking van symmetrieën in getallen.

Kernconcepten:
- Operatie: Een transformatie op getallen (reverse, digitsum, sort, etc.)
- Pipeline: Een compositie van operaties
- Attractor: Een vast punt of cyclus waar een pipeline naar convergeert
- Symmetrie: Een patroon dat geldt voor een klasse getallen

Hardware: Geoptimaliseerd voor RTX 4000 Ada, 32-core i9, 64GB RAM
...
class DiscoveryConfig:
    """Configuratie voor de discovery engine."""
...
# =============================================================================
# OPERATIES - De bouwstenen van transformaties
# =============================================================================

class Operation(ABC):
    """Abstracte basisklasse voor getaloperaties."""
...
class DiscoveryEngine:
    ...
    def run(self, num_generations: int = 100, verbose: bool = True):
        ...
        print(f"Operaties: {len(OPERATION_REGISTRY)}")
        print(f"Cijferbereiken: {self.config.digit_ranges}")
        print("=" * 70)
        ...
        for gen in range(num_generations):
            ...
            if verbose and (gen % self.config.log_interval == 0 or discoveries):
                ...
                for pattern, score in discoveries:
                    print(f"\n  🎯 NIEUWE ONTDEKKING (score: {score:.1f})")
                    ...
                    if pattern.cycle_values:
                        print(f"     Cyclus: {pattern.cycle_values}")
        ...
        print(f"Ontdekkingen: {len(self.discoveries)}")
...
def main():
    ...
    print(f"\n✅ Klaar! {len(discoveries)} patronen ontdekt.")
