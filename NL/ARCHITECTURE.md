...
2. **1089×m family**: `(b-1)(b+1)²×m` for m=1..b-1 — **UNIVERSEEL** (**DS040**)
...
LAYER 6: Multi-base Generalisatie     BaseNDigitOps, cross-base vergelijking
...
| **R9** | Cascade | Pad B: Modules S–U, DS046–DS052, 22 ops, Armstrong, odd-base Kaprekar, orbits, 76 tests |
| **R10** | Cascade | Pad D: Modules V–Z, DS053–DS060, Lyapunov, repunits, cycle taxonomy, multi-digit Kaprekar, 98 tests |
