...
From "what is true" to "why is it true".

Five new modules compared to v8.0:
  E. KNOWLEDGE BASE — Proven theorems, not measured. Closes gaps.
  F. CAUSAL CHAIN CONSTRUCTOR — From statistics to mechanistic explanation
  G. SURPRISE DETECTOR — Recognize anomalies, generate follow-up questions
  H. GAP CLOSURE LOOP — Proven facts automatically close proof gaps
  I. SELF-QUESTIONING — After each discovery: "why?" and "what follows?"

Core principle: "Now I understand."
...
class CausalStep:
    claim: str
    justification: str
    source: str  # fact_id or "empirical" or "definition"
