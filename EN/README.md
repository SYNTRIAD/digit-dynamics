...
│
└── docs/                      ← Documentation
    ├── EVOLUTION_FROM_SCRIPTS_TO_REASONING.md  ← ★ Main evolution document
    ├── WHAT_WE_DISCOVERED.md                   ← The P_k discovery (accessible)
    ├── DISCOVERY_ENGINES_DOCUMENTATION.md       ← Engine version details
    ├── claude-opus-isomorphism-reasoning-pattern.md ← Isomorphism analysis
    ├── observations_symbolic_dynamics_engine.md  ← Manus observations
    ├── ADVERSARIAL_AUDIT_REPORT.md              ← Full adversarial audit
    ├── FORMAL_VERIFICATION_REPORT.md            ← Verification results
    ├── PUBLICATION_STRATEGY.md                  ← A/B/C paper strategy
    ├── MANUS_PROMPT_R6.md                       ← Manus session prompt
    ├── LINKEDIN_REASONING_CAN_BE_LEARNED.md     ← LinkedIn post
    ├── reflections/                             ← Reflective essays & self-steering
    │   ├── REFLECTION_PROJECT.md
    │   ├── REFLECTION_TRIANGLE_DIALOGUE_P_k.md
    │   ├── REFLECTION_V8.md
    │   ├── REFLECTION_V10.md
    │   ├── SELF_PROMPT_V8.md
    │   └── SELF_PROMPT_V10.md
    └── protocol-simulation/                     ← Research 2.0 protocol (Manus)
...
Read the full story: [`docs/EVOLUTION_FROM_SCRIPTS_TO_REASONING.md`](docs/EVOLUTION_FROM_SCRIPTS_TO_REASONING.md)
...
|----------|----------|-------|
| [`EVOLUTION_FROM_SCRIPTS_TO_REASONING.md`](docs/EVOLUTION_FROM_SCRIPTS_TO_REASONING.md) | Everyone | Complete evolution story |
| [`WHAT_WE_DISCOVERED.md`](docs/WHAT_WE_DISCOVERED.md) | Everyone | The P_k projection discovery |
| [`claude-opus-isomorphism-reasoning-pattern.md`](docs/claude-opus-isomorphism-reasoning-pattern.md) | Researchers | Isomorphism to agent architectures |
