...
Start different discovery modes:
- explore: CPU evolutionary search
- gpu: GPU-accelerated batch experiments  
- meta: Self-learning meta-system
- demo: Quick demo of all capabilities
...
def run_demo(args):
    ...
    # Demo 1: Known patterns
    print("\n\n" + "="*60)
    print("DEMO 1: VERIFY KNOWN PATTERNS")
    print("="*60)
    
    known_pipelines = [
        (['kaprekar_step'], "Kaprekar's constant"),
        (['truc_1089'], "1089 trick"),
    ...
    print("\n\n" + "="*60)
    print("DEMO 2: RANDOM PIPELINE GENERATION")
    print("="*60)
    ...
    for _ in range(5):
        ...
        for n in [123, 4567, 98765]:
            ...
            print(f"  {n} → {final} (in {len(seq)-1} steps)")
    
    # Demo 3: Operations
    print("\n\n" + "="*60)
    print("DEMO 3: AVAILABLE OPERATIONS")
    print("="*60)
